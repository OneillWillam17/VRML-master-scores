# TODO: Figure out how tf do get matches from a different class but inside the same result set????
...
class Ethereal:
    ...
    def __init__(self):
        self.URL = 'https://vrmasterleague.com/EchoArena/Teams/kn8wkhtF2PFUESu3zYZe7g2'
        self.info = []

    def ethereal_scrape(self):
        ...
        # match_list = soup.find_all('tr', string=lambda text: 'ethereal' in text.lower())
        # matches = [tr_element.parent.parent.parent for tr_element in match_list]
